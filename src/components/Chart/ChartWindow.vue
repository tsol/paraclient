<template>
  <v-row justify="center">
    <v-dialog v-model="isOpen" fullscreen hide-overlay transition="dialog-bottom-transition" eager>
      <v-card>
...
export default {
  ...
  computed: {
    tickerId() {
      return this.$store.state.chart.tickerId;
    },
    isOpen: {
      get() {
      ...
      set(v) {
        this.$store.commit('chart/openWindow', v);
      },
    },
  },
  watch: {
